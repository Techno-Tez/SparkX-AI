...
const Testimonials = () => {
    return (
        <section className=" text-white/60 body-font">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 -m-4 gap-3">
                    <div className=" lg:mb-0 p-8 bg-gray-300/10 rounded-lg">
                        <div className={cn("h-full text-center text-sm md:text-lg", font.className)}>
                            <img alt="testimonial" className="w-20 h-20 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100" src="/pfp4.jpg" />
                    ...
                    <div className=" lg:mb-0 p-8 bg-gray-300/10 rounded-lg">
                        <div className={cn("h-full text-center text-sm font-light md:text-lg", font.className)}>
                            <img alt="testimonial" className="w-20 h-20 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100" src="/pfp.png" />
                    ...
                    <div className=" lg:mb-0 p-8 bg-gray-300/10 rounded-lg">
                        <div className={cn("h-full text-center text-sm font-light md:text-lg", font.className)}>
                            <img alt="testimonial" className="w-20 h-20 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100" src="/pfp5.jpg" />
